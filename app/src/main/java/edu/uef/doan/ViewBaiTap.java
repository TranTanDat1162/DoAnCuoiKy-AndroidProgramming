                    ...
                    for (int i = 0; i < selectedFiles2.size(); i++) {
                        ...
                        storageRef.putFile(fileUri)
                                ...
                                .addOnFailureListener(e -> {
                                    ...
                                    Toast.makeText(ViewBaiTap.this, "Lỗi khi tải tệp lên Firebase Storage: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
...
//        });
    ...
    private void showSelectedFileList2() {
        ...
        ViewBaiTap.SelectedFilesAdapter adapter = new ViewBaiTap.SelectedFilesAdapter(this, selectedFileNames2, selectedFiles2);
        selectedFilesListView.setAdapter(adapter);
                            ...
                            item.getFile(generated)
                                    .addOnSuccessListener(taskSnapshot ->{
                                        Log.v("DownloadAttachment",item.getName()+" downloaded at"
                                                + localFile.getPath()+"/"+ item.getName());
                                        Uri uri = FileProvider.getUriForFile(ViewBaiTap.this, getApplication().getPackageName()+ ".fileprovider", generated);
