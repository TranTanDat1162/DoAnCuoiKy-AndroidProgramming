...
//        String id = userDocument.getId();
//        db.collection("users").document(id).set(user);
//        // Tạo một Map chứa thông tin về files đính kèm
//        Map<String, Object> attachmentInfo = new HashMap<>();
//        attachmentInfo.put("fileName", fileName);
//        attachmentInfo.put("fileUrl", fileUrl);
//
//        // Lưu thông tin files đính kèm vào Firestore trong bảng "attachments"
//        db.collection("users").document(id).collection("assignment")
//                .add(attachmentInfo)
//                .addOnSuccessListener(documentReference -> {
//                    // Xử lý khi thông tin files đính kèm được lưu thành công
//                    Log.d(TAG, "files đính kèm được lưu thành công: " + documentReference.getId());
//                })
//                .addOnFailureListener(e -> {
//                    // Xử lý khi thông tin files đính kèm không thể được lưu vào Firestore
//                    Log.w(TAG, "Lỗi khi lưu thông tin files đính kèm vào Firestore", e);
//                });
//    }
